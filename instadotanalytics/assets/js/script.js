...
$(function(){
  $(window).scroll(function() {              
    $('#insta_log').toggle($(document).scrollTop() > 100);
  });
})
...
$('.popup').magnificPopup({
  ...
  // leader section image slider

  $('.inst_leader_img_col .owl-carousel').owlCarousel({
    loop:true,
    margin:10,
    nav:false,
    dots:false,
...
$('.insta_university_partner .owl-carousel').owlCarousel({
  loop:true,
  margin:10,
  nav:true,
  dots:false,
